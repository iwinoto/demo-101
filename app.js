...
app.get('/api/favorites/killInstance', function(request, response) {
	console.log("Killing this instance");
	process.exit(-1);
});

app.get('/api/favorites/instanceIndex', function(request, response) {
